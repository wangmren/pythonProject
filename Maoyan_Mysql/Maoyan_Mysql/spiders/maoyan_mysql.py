...
class MaoyanMysqlSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for offset in range(0, 91, 10):
            url = 'https://www.maoyan.com/board/4?timeStamp=1638962905523&channelId=40011&index=1&signKey=cb357464ef369578b9d3d41970526d35&sVersion=1&webdriver=false&offset={}'.format(
                offset)
            # 交给调度器入队列
